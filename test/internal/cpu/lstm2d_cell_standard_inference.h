#ifndef RNN2D_TEST_INTERNAL_CPU_RNN2D_LSTM2D_STANDARD_CELL_INFERENCE_H_
#define RNN2D_TEST_INTERNAL_CPU_RNN2D_LSTM2D_STANDARD_CELL_INFERENCE_H_
...
class Lstm2dStandardCellInferenceCpuTest : public ::testing::Test {};
TYPED_TEST_CASE_P(Lstm2dStandardCellInferenceCpuTest);

TYPED_TEST_P(Lstm2dStandardCellInferenceCpuTest, ForwardAllParamsZero) {
...
TYPED_TEST_P(Lstm2dStandardCellInferenceCpuTest, ForwardBias) {
  typedef TypeParam Lstm2dInferenceImpl;
  typedef typename TypeParam::DataType T;
...
TYPED_TEST_P(Lstm2dStandardCellInferenceCpuTest, ForwardInputWeights) {
  typedef TypeParam Lstm2dInferenceImpl;
  typedef typename TypeParam::DataType T;
...
TYPED_TEST_P(Lstm2dStandardCellInferenceCpuTest, ForwardRecurrentXWeights) {
  typedef TypeParam Lstm2dInferenceImpl;
  typedef typename TypeParam::DataType T;
...
TYPED_TEST_P(Lstm2dStandardCellInferenceCpuTest, ForwardRecurrentYWeights) {
  typedef TypeParam Lstm2dInferenceImpl;
...
REGISTER_TYPED_TEST_CASE_P(Lstm2dStandardCellInferenceCpuTest,
...
#endif  // RNN2D_TEST_INTERNAL_CPU_RNN2D_LSTM2D_STANDARD_CELL_INFERENCE_H_

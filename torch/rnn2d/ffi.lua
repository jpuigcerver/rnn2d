...
void rnn2d_stable_lstm_cpu_float_fw_inference(
    const int H, const int W, const int N, const int K, const int D,
    const float* input, const int* shape, const float* param, float* output,
    void* workspace);

void rnn2d_stable_lstm_cpu_float_fw_training(
    const int H, const int W, const int N, const int K, const int D,
    const float* input, const int* shape, const float* param, float* output,
    void* workspace, void* reserve);

void rnn2d_stable_lstm_cpu_float_bw_data(
    const int H, const int W, const int N, const int K, const int D,
    const float* input, const int* shape, const float* param,
    const float* output, const float* dOutput, float* dInput,
    void* workspace, void* reserve);
...
void rnn2d_stable_lstm_cpu_double_fw_inference(
    const int H, const int W, const int N, const int K, const int D,
    const double* input, const int* shape, const double* param, double* output,
    void* workspace);

void rnn2d_stable_lstm_cpu_double_fw_training(
    const int H, const int W, const int N, const int K, const int D,
    const double* input, const int* shape, const double* param, double* output,
    void* workspace, void* reserve);

void rnn2d_stable_lstm_cpu_double_bw_data(
    const int H, const int W, const int N, const int K, const int D,
    const double* input, const int* shape, const double* param,
    const double* output, const double* dOutput, double* dInput,
    void* workspace, void* reserve);
...
void rnn2d_stable_lstm_gpu_float_fw_inference(
    const int H, const int W, const int N, const int K, const int D,
    const float* input, const int* shape, const float* param, float* output,
    void* workspace);

void rnn2d_stable_lstm_gpu_float_fw_training(
    const int H, const int W, const int N, const int K, const int D,
    const float* input, const int* shape, const float* param, float* output,
    void* workspace, void* reserve);

void rnn2d_stable_lstm_gpu_float_bw_data(
    const int H, const int W, const int N, const int K, const int D,
    const float* input, const int* shape, const float* param,
    const float* output, const float* dOutput, float* dInput,
    void* workspace, void* reserve);
...
void rnn2d_stable_lstm_gpu_double_fw_inference(
    const int H, const int W, const int N, const int K, const int D,
    const double* input, const int* shape, const double* param, double* output,
    void* workspace);

void rnn2d_stable_lstm_gpu_double_fw_training(
    const int H, const int W, const int N, const int K, const int D,
    const double* input, const int* shape, const double* param, double* output,
    void* workspace, void* reserve);

void rnn2d_stable_lstm_gpu_double_bw_data(
    const int H, const int W, const int N, const int K, const int D,
    const double* input, const int* shape, const double* param,
    const double* output, const double* dOutput, double* dInput,
    void* workspace, void* reserve);

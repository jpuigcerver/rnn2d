...
void LstmWrapper<float>::BackwardData() {
  rnn2d_lstm_cpu_float_bw_data(H_, W_, N_, K_, D_, input_, nullptr, param_, output_, gradOutput_, gradInput_, wspace_, rspace_);
}

template <>
void LstmWrapper<double>::BackwardData() {
  rnn2d_lstm_cpu_double_bw_data(H_, W_, N_, K_, D_, input_, nullptr, param_, output_, gradOutput_, gradInput_, wspace_, rspace_);
}
